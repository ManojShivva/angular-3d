...
@Component({
  selector: 'app-character-display3-d',
  templateUrl: './character-display3-d.component.html',
  styleUrls: ['./character-display3-d.component.css']
})
export class CharacterDisplay3DComponent {
  character!: Character[];
  ...
  private createScene() {
    ...
    // });
    this.loaderGLTF.load(this.refPathURL1, (gltf: GLTF) => {
      this.model = gltf.scene.children[0];
      console.log(this.model);
      var box = new THREE.Box3().setFromObject(this.model);
      box.getCenter(this.model.position); // this re-sets the mesh position
 ...
 */
  private startRenderingLoop() {
    ...
    let component: CharacterDisplay3DComponent = this;
    (function render() {
